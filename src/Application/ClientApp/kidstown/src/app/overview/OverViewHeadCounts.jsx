...
import { fetchLocationGroups, postWithJsonResult } from '../helpers/BackendClient'
...
export default function OverviewHeadCount() {
  ...
  async function loadData() {
    const locationGroups =
      state.locationGroups.length === 0 ? await fetchLocationGroups() : state.locationGroups
  ...
  async function fetchData() {
    const selectedOptions = getSelectedOptionsFromStorage('overviewLocationGroups', [])
