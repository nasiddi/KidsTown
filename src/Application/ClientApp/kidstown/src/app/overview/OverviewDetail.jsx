...
import { post } from '../helpers/BackendClient.jsx'
...
export default function OverviewDetail() {
              ...
              <AccordionDetails>
                <Grid container spacing={1}>
                  ...
                  <Grid size={{ xs: 12, md: 4 }}>
                    {renderVolunteerTable(attendees['volunteers'])}
                  </Grid>
                </Grid>
              </AccordionDetails>
            </Accordion>
  ...
  async function fetchData() {
    const selectedOptionsFromStorage = getSelectedOptionsFromStorage('overviewLocationGroups', [])
  ...
  function getStateBadge(state) {
    ...
    return (
      <Chip color={color} label={state} size="small" style={{ width: '-webkit-fill-available' }} />
    )
  }
