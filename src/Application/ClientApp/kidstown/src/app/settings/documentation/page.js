...
import {onDeleteSubElement, onDownSubElement, onUpSubElement, sortDocElements,} from '../../documentation/DynDocHelpers'
...
export default function DynDocsEdit() {
    ...
    async function saveDoc() {
        ...
        const res = await post('documentation', state.documentation)
        ...
        <NarrowLayout>
            ...
            >
                ...
                {state.alert.text.length > 0 ? (
                    <KidsTownAlert alert={state.alert}/>
                ) : (
                    <></>
                )}
