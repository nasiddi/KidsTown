...
{
    public class SearchLoggingRepository : ISearchLoggingRepository, ISearchLogCleanupRepository
    {
        private readonly IServiceScopeFactory _serviceScopeFactory;

        public SearchLoggingRepository(IServiceScopeFactory serviceScopeFactory)
        {
        ...
        )
        {
            ...
            var searchLog2Attendances = people.Select(p => new SearchLog2Attendance
            {
